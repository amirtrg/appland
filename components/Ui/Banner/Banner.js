...
const Banner = ({ title }) => {
  return (
    <div className="flex gap-x-2">
      <Card className="mt-4 mx-0 p-0 shadow-none rounded-none overflow-hidden w-full relative border-2 border-gray-900/20 aspect-video bg-black hidden md:block">
    ...
    <Card className="mt-4 mx-0 py-0 px-0 bg-black shadow-none rounded-none overflow-hidden w-full relative border-2 border-gray-900/20   md:block aspect-video">
    ...
    <Card className="mt-4 mx-0 py-0 px-0 shadow-none rounded-none overflow-hidden w-full relative  bg-black aspect-video hidden md:block">
